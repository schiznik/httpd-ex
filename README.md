...
```
$ s2i build https://github.com/schiznik/httpd-ex centos/httpd-24-centos7 myhttpdimage
...
`$ oc new-app centos/httpd-24-centos7~https://github.com/schiznik/httpd-ex`

You can also deploy the sample template for the application:

`$ oc new-app -f https://raw.githubusercontent.com/schiznik/httpd-ex/master/openshift/templates/httpd.json`
